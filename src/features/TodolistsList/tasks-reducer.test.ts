...
type TestThunkAction<T extends (...args: any) => void> = Omit<
  ReturnType<T>,
  "meta"
>;
...
test("correct task should be added to correct array", () => {
  ...
  const action:TestThunkAction<typeof addTaskTC.fulfilled> = {
...
test("tasks should be added for todolist", () => {
  const action: TestThunkAction<typeof fetchTaskTC.fulfilled> = {
    type: fetchTaskTC.fulfilled.type,
    payload: {
